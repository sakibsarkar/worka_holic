  ...
  return (
    <nav className="bg-white w-full flex  py-[20px] ">
        ...
        <div className="flex justify-between items-center gap-3">
          {user?._id ? (
            <>
              <div className="relative">
                <span
                  ...
                  className="w-[40px] h-[40px]  ring-2 ring-gray-100 overflow-hidden inline-block p-[2px] rounded-full"
                >
                  <Image
                ...
                {isToggle && (
                  <ul className="absolute right-0 top-full w-[150px] bg-white overflow-hidden z-10 rounded-md shadow">
                    <li>
                      {" "}
                      <Link
                        href={`/${user?.userName}`}
                        className="px-3 py-2 hover:bg-gray-100 w-full inline-block text-gray-700"
                      >
                        Dashboard
                      </Link>{" "}
                    </li>
                    <li>
                      ...
                      <button
                        onClick={() => signOut()}
                        className="px-3 py-2 text-left hover:bg-gray-100 w-full inline-block text-gray-700"
                      >
                        Logout
                      </button>{" "}
                    </li>
            ...
            <>
              ...
              <Link
                href={"/login"}
                className="bg-[#007456] text-white flex justify-center items-center w-[120px] py-[7px] rounded-3xl text-[#007456s]"
              >
                Login
              </Link>
            </>
      ...
      <div className="bg-white w-[95%] flex justify-between py-[10px] md:hidden">
        ...
        <div
          className="fixed left-0 top-0 h-screen w-[0] bg-[lightgrey] z-50"
          id={show ? "drawerOpen" : "drawerClose"}
        >
          <button
            onClick={handleHide}
            className="absolute top-[10px]
                        right-[20px] text-[30px] cursor-pointer z-[999]"
          >
            <RxCross2 />
          </button>
